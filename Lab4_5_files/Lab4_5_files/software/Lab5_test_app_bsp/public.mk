...
# setting SOPC_SYSID_BASE_ADDRESS is 0x110b0
SOPC_SYSID_FLAG += --sidp=0x110b0
ELF_PATCH_FLAG  += --sidp 0x110b0

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1496882533
SOPC_SYSID_FLAG += --timestamp=1496882533
ELF_PATCH_FLAG  += --timestamp 1496882533
